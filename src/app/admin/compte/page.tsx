        ...
        <main className=''>
            ...
            <section className="bg-three/40">
                <article className='grid grid-cols-2 p-3 border-b'>
                    <div><Text>Nom du magasin </Text> </div>
                    <div><Text>Collector Clothes Design</Text> </div>
                </article>
                <article className='grid grid-cols-2 p-3 border-b'>
                    <div><Text>Proprietaire</Text> </div>
                    <div><Text>Helene Bonda</Text> </div>
                </article>
                <article className='grid grid-cols-2 p-3 border-b'>
                    <div><Text>Categorie</Text> </div>
                    <div><Text>Habillement et Accessoire</Text> </div>
                </article>
                <article className='grid grid-cols-2 p-3 border-b'>
                    <div><Text>Logo</Text> </div>
                    <div><Text></Text> </div>
                </article>
            </section>
            <section className="bg-three rounded-sm w-full">
